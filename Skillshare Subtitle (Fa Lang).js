// ==UserScript==
// @name:fa   Skillshare Subtitle v1
// @name         Skillshare Subtitle (farsi)
// @namespace    https://roox.site      //    https://github.com/amirroox
// @version      1
// @description:fa  Download Subtitle (.srt) & Download Movie (.mp4)
...
(function () {
  ...
  async function inject_our_script() {
    ...
    var button_text = `دانلود همه زیرنویس ها (${subtitle_count} 个 .srt فایل)`;
